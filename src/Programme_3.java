...
public class Programme_3 {
    //3.1 Declare on instance and one static variable
    String name = "Prime";
    ...
    // call both nstance and static variables into both instance and static methods inside the print statement.
